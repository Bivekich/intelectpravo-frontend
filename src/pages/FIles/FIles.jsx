  ...
  useEffect(() => {
    const fetchFiles = async () => {
      const response_boughts = await axios({
        method: "get",
        url: `http://localhost:3030/sale/user-boughts`, // Pass limit and offset as query params
        headers: {
      ...
      const response_selled = await axios({
        method: "get",
        url: `http://localhost:3030/sale/user-selled`, // Pass limit and offset as query params
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
      ...
      const response_myfiles = await axios({
        method: "get",
        url: `http://localhost:3030/sale/user-sales`, // Pass limit and offset as query params
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
